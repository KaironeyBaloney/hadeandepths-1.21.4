...
public class WoodenFishingHookRenderer extends EntityRenderer<WoodenFishingHook> {
    ...
    public WoodenFishingHookRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public void render(WoodenFishingHook entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
    ...
    @Override
    public ResourceLocation getTextureLocation(WoodenFishingHook entity) {
