...
public class MagmaticFishingHookRenderer extends EntityRenderer<MagmaticFishingHook> {
    ...
    public MagmaticFishingHookRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public void render(MagmaticFishingHook entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
    ...
    @Override
    public ResourceLocation getTextureLocation(MagmaticFishingHook entity) {
