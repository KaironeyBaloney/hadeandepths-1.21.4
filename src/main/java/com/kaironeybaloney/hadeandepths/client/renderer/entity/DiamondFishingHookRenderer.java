...
public class DiamondFishingHookRenderer extends EntityRenderer<DiamondFishingHook> {
    ...
    public DiamondFishingHookRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public void render(DiamondFishingHook entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
    ...
    @Override
    public ResourceLocation getTextureLocation(DiamondFishingHook entity) {
