...
public class DiamondFishingHookRenderer extends EntityRenderer<DiamondFishingHook, FishingHookRenderState> {
    private static final ResourceLocation TEXTURE_LOCATION = ResourceLocation.fromNamespaceAndPath("hadeandepths", "textures/entity/diamond_fishing_hook.png");
    private static final RenderType RENDER_TYPE;
    private static final double VIEW_BOBBING_SCALE = 960.0;

    public DiamondFishingHookRenderer(EntityRendererProvider.Context ctx) {
        super(ctx);
    }

    public boolean shouldRender(DiamondFishingHook p_363069_, Frustum p_362635_, double p_361840_, double p_361502_, double p_360380_) {
    ...
    public void extractRenderState(DiamondFishingHook p_361584_, FishingHookRenderState p_364824_, float p_360891_) {
    ...
    protected boolean affectedByCulling(DiamondFishingHook p_365042_) {
        return false;
    }
