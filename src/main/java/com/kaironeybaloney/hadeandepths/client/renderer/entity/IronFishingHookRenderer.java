...
public class IronFishingHookRenderer extends EntityRenderer<IronFishingHook, FishingHookRenderState> {
    private static final ResourceLocation TEXTURE_LOCATION = ResourceLocation.fromNamespaceAndPath("hadeandepths", "textures/entity/iron_fishing_hook.png");
    private static final RenderType RENDER_TYPE;
    private static final double VIEW_BOBBING_SCALE = 960.0;

    public IronFishingHookRenderer(EntityRendererProvider.Context ctx) {
        super(ctx);
    }

    public boolean shouldRender(IronFishingHook p_363069_, Frustum p_362635_, double p_361840_, double p_361502_, double p_360380_) {
    ...
    public void extractRenderState(IronFishingHook p_361584_, FishingHookRenderState p_364824_, float p_360891_) {
    ...
    protected boolean affectedByCulling(IronFishingHook p_365042_) {
        return false;
    }
