...
public class IronFishingHookRenderer extends EntityRenderer<IronFishingHook> {
    ...
    public IronFishingHookRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public void render(IronFishingHook entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
    ...
    @Override
    public ResourceLocation getTextureLocation(IronFishingHook entity) {
