...
public class PinkNiteliteJarBlockEntity extends BlockEntity {
    public PinkNiteliteJarBlockEntity(BlockPos pos, BlockState state) {
        super(PINK_NITELITE_JAR_BLOCK_ENTITY.get(), pos, state);
    }

    private int tickCounter = 0;

    public static void tick(Level level, BlockPos pos, BlockState state, PinkNiteliteJarBlockEntity be) {
        be.tickCounter++;
    }
